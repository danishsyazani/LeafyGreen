            ...
            child: Column(
              ...
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Image.asset('assets/images/camepic.png',
                        width: 100,
                        height: 100), // Change the dimensions as needed
                    SizedBox(width: 20), // Add spacing between image and button
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Color.fromARGB(255, 91, 142, 85),
                      ),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Image.asset('assets/images/gllerypic.png',
                        width: 100,
                        height: 100), // Change the dimensions as needed
                    SizedBox(width: 20), // Add spacing between image and button
                    ElevatedButton(
