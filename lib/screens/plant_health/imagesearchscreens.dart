...
import 'package:leafygreen/screens/plant_health/health_screen.dart';
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
                'assets/images/plant_iden.jpg'), // Add your image asset here
            SizedBox(height: 20),
            buildElevatedButton(
              context,
  ...
  return Container(
    ...
    child: ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        foregroundColor: Colors.white, backgroundColor: Color.fromARGB(255, 91, 142, 85), // Text color
