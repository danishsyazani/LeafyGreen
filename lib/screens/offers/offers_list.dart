...
import 'package:leafygreen/screens/offers/create_offer.dart';
import 'package:leafygreen/screens/offers/offers_notification.dart';
import 'package:leafygreen/screens/offers/single_offer.dart';
...
class _OffersListState extends State<OffersList> {
  ...
  Future<List<Offer>> _getItemsForAllUsers() async {
    ...
    for (String uid in common) {
      if (uid != "dummy") {
        //get QuerySnapshot of those whose uid is not dummy
